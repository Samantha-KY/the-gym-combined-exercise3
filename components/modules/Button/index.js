...
const Button = ({ title, fullWidth = false, width = 202 }) => {
  return (
    <button
      ...
      after:top-0 after:bottom-0 overflow-hidden border border-white border-spacing-1 hover:border-indigo-700
    after:bg-white  after:absolute relative 
      ...
      hover:after:duration-500 text-white hover:text-indigo-700 font-montHavy-extralight 
